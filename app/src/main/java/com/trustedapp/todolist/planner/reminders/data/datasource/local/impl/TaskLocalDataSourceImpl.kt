...
class TaskLocalDataSourceImpl @Inject constructor(private val dao: TaskDao) : TaskLocalDataSource {
    ...
    override fun getTaskInDay(dayString: String, start: Long, end: Long) = dao.getTaskInDay(dayString, start)
    ...
    override fun getTaskInDayAll(dayString: String, start: Long, end: Long) = dao.getTaskInDayAll(dayString, start)
}
