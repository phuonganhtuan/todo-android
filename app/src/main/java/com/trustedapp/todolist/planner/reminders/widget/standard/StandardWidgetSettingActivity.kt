...
import com.trustedapp.todolist.planner.reminders.databinding.ActivityWidgetStandardSettingBinding
...
class StandardWidgetSettingActivity : BaseActivity<ActivityWidgetStandardSettingBinding>() {

    private val viewModel by lazy {
        StandardWidgetSettingViewModel(
    ...
    private val taskPreviewAdapter = StandardPreviewWidgetAdapter()
    ...
    private var timeFilter = FilterTime.ALL_TIME.name

    override fun inflateViewBinding() =
        ActivityWidgetStandardSettingBinding.inflate(layoutInflater)
    ...
    private fun initViews() = with(viewBinding) {
        header.apply {
            ...
            button3.hide()
            button4.hide()
            textTitle.text = getString(R.string.standard)
        }
    ...
    private fun setupEvents() = with(viewBinding) {
        ...
        switchCompleted.setOnClickListener {
            viewModel.getPreviewData(
                this@StandardWidgetSettingActivity,
                switchCompleted.isChecked,
                selectCatId,
                isOnlyToday,
            )
